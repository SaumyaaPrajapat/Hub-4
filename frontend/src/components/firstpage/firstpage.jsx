      ...
      <div className="groupedSectionStyle">
        <div className="newBox">
          ...
          <div className="otherStyle">
            ...
            dedicated dashboard. Designed to simplify your management processes,
            this centralized hub ensures that tracking employee numbers and
            managing salaries becomes a breeze.
          </div>
        </div>
